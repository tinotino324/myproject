...
<body>
  ...
  <section class="contact-banner h-b">
    ...
    <div class="container h-100 d-flex flex-column justify-content-center align-items-center text-center">
      ...
      <h1 class="banner-text">Flooring</h1>
  ...
  <section class="product-details container my-5">
    ...
    <div class="row">
      ...
      <h1 class="fw-bold">Premium Vinyl Flooring</h1>
    ...
    <div class="row my-4">
      ...
      <div class="col-lg-8">
        ...
        <p class="text-muted">
          ...
          Experience the perfect combination of style, durability, and convenience with our premium vinyl flooring. 

          Expertly designed to replicate the natural beauty of wood, stone, or tile, it offers an elegant yet practical flooring solution 

          that effortlessly enhances the look of any space.
      ...
      <p class="text-muted">
          ...
          Ideal for homes, offices, and commercial areas, our vinyl flooring provides a cost-effective and versatile alternative to traditional materials. 

          Its resilient construction ensures long-lasting performance, while its easy maintenance makes it a smart choice for modern lifestyles, 

          blending functionality with timeless appeal.
      ...
      <p class="text-muted">
          ...
          With a wide range of patterns, finishes, and textures to choose from, you can create a customized look that perfectly complements your interior design. 

          Whether you’re aiming for a cozy home atmosphere or a sleek professional setting, our vinyl flooring adapts to your needs, 

          bringing style and practicality together in every step.
      ...
      <div class="col-lg-4">
        ...
        <div class="features-box p-4 rounded shadow-sm">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li><i class="fa fa-check-circle me-2"></i> Realistic Wood & Stone Finishes</li>

            <li><i class="fa fa-check-circle me-2"></i> Water-Resistant & Durable</li>

            <li><i class="fa fa-check-circle me-2"></i> Soft & Noise-Reducing</li>

            <li><i class="fa fa-check-circle me-2"></i> Easy Installation & Care</li>

            <li><i class="fa fa-check-circle me-2"></i> Variety of Designs & Textures</li>
    ...
    <div class="row g-3">
      ...
      <div class="col-6 col-md-3 four-img">
        ...
        <img src="assets/img/product/curtains/3.webp" class="img-fluid rounded popup-img" alt="" data-bs-toggle="modal"
      ...
      <div class="col-6 col-md-3 four-img">
        ...
        <img src="assets/img/product/curtains/9.webp" class="img-fluid rounded popup-img" alt="" data-bs-toggle="modal"
      ...
      <div class="col-6 col-md-3 four-img">
        ...
        <img src="assets/img/product/curtains/5.webp" class="img-fluid rounded popup-img" alt="" data-bs-toggle="modal"
      ...
      <div class="col-6 col-md-3 four-img">
        ...
        <img src="assets/img/product/curtains/23.webp" class="img-fluid rounded popup-img" alt="" data-bs-toggle="modal"
    ...
    <div class="row my-4">
      ...
      <div class="col-12">
        ...
        <p>Whether you’re aiming for a warm wooden look, a sleek stone finish, or a customized design, our vinyl

          flooring provides an attractive, practical, and long-lasting solution. Perfect for high-traffic areas, it

          ensures beauty with performance — redefining your space with ease.</p>
    ...
    <div class="container">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 text-white p-5">
          ...
          <p class="text-white">Transform your home with our premium décor collection — elegance made simple.</p>
