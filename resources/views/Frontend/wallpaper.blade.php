...
<body>
  ...
  <section class="contact-banner h-b">
    ...
    <div class="container h-100 d-flex flex-column justify-content-center align-items-center text-center">
      ...
      <h1 class="banner-text">Wallpapers</h1>
  ...
  <section class="product-details container my-5">
    ...
    <div class="row">
      ...
      <h1 class="fw-bold">Premium Designer Wallpapers</h1>
    ...
    <div class="row my-4">
      ...
      <div class="col-lg-8">
        ...
        <p class="text-muted">
          ...
          Redefine your interiors with our premium designer wallpapers — a perfect combination of artistic elegance and lasting quality. 

          Crafted from high-grade materials, they are designed to transform ordinary walls into captivating focal points, 

          bringing depth, character, and style to every room in your home or office.
      ...
      <p class="text-muted">
          ...
          Whether you prefer bold, eye-catching patterns or subtle, sophisticated textures, our collection offers designs 

          that cater to every taste and interior style. Durable, easy to maintain, and effortlessly stylish, our wallpapers 

          provide a timeless solution for creating visually stunning spaces that reflect your unique personality.
      ...
      <div class="col-lg-4">
        ...
        <div class="features-box p-4 rounded shadow-sm">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li><i class="fa fa-check-circle me-2"></i> High-Quality, Durable Materials</li>

            <li><i class="fa fa-check-circle me-2"></i> Wide Range of Patterns, Textures</li>

            <li><i class="fa fa-check-circle me-2"></i> Easy to Apply & Maintain</li>

            <li><i class="fa fa-check-circle me-2"></i> Customizable Designs</li>
    ...
    <div class="row my-4">
      ...
      <div class="col-12">
        ...
        <p>Whether you prefer minimalist textures, bold patterns, or artwork-inspired custom designs, our wallpapers are

          tailored to complement every décor style. Create an ambiance that reflects your personality — from cozy and

          warm to bold and luxurious.</p>
