...
<body>
  ...
  <section class="contact-banner h-b">
    ...
    <div class="container h-100 d-flex flex-column justify-content-center align-items-center text-center">
      ...
      <h1 class="banner-text">Carpets</h1>
  ...
  <section class="product-details container my-5">
    ...
    <div class="row">
      ...
      <div class="col-12 detail-img">
        ...
        <h1 class="fw-bold">Premium Designer Carpets</h1>
    ...
    <div class="row my-4">
      ...
      <div class="col-lg-8">
        ...
        <p class="text-muted">
          ...
          Add warmth, elegance, and comfort to your interiors with our premium designer carpets — the perfect blend of style and functionality. 

          Crafted from high-quality materials, they are designed to enhance the visual appeal of your space while providing a soft, luxurious feel underfoot, 

          making every step a delightful experience.
      ...
      <p class="text-muted">
          ...
          Available in a wide range of colors, patterns, and textures, our carpets cater to diverse décor preferences, 

          from contemporary minimalism to timeless classics. Durable and easy to maintain, they not only elevate the beauty of any room 

          but also create a welcoming and sophisticated ambiance that lasts for years.
      ...
      <div class="col-lg-4">
        ...
        <div class="features-box p-4 rounded shadow-sm">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li><i class="fa fa-check-circle me-2"></i> Soft & Comfortable Texture</li>

            <li><i class="fa fa-check-circle me-2"></i> Easy to Clean & Maintain</li>

            <li><i class="fa fa-check-circle me-2"></i> Custom Sizes & Styles Available</li>
    ...
    <div class="row my-4">
      ...
      <div class="col-12">
        ...
        <p>Whether you’re looking for a classic patterned carpet, a plush modern design, or a custom piece to suit your

          décor, our collection offers the perfect combination of functionality and style — making your living spaces
