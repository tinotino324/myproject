...
<body>
  ...
  <section class="contact-banner h-b">
    ...
    <div class="container h-100 d-flex flex-column justify-content-center align-items-center text-center">
      ...
      <h1 class="banner-text">{{$file_name}}</h1>

      <nav class="breadcrumb-nav">

        <a href="{{('/home')}}">Home</a> <span>&raquo;</span> <span>Our Products</span> <span>&raquo;</span>
  ...
  <section class="product-details container my-5">
    ...
    <div class="row">
      ...
      <h1 class="fw-bold">{{$file_name}}</h1>

      <div class="col-12 detail-img">

      <img src="{{ asset('storage/' . $products->image) }}" class="img-fluid rounded" alt="Product Image">
    ...
    <div class="row g-3">
    <?php $galley = json_decode($products->images); ?>

    @foreach($galley as $img)
      <div class="col-6 col-md-3 four-img">

        <img src="{{ asset('storage/' . $img->image) }}" class="img-fluid rounded popup-img" alt="" data-bs-toggle="modal"
