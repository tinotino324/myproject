...
<body class="bg-light d-flex align-items-center justify-content-center" style="height: 100vh;">
    ...
    <div class="card shadow p-4" style="width: 100%; max-width: 400px;">
        <h3 class="text-center mb-4">Profile Edit</h3>
        ...
        <div class='form-group col-lg-12 mb-3' id='nameDiv'>
            ...
            <input type="name" name="name" id="name" class="form-control" value="{{ $user->name }}" required autofocus>
        ...
        <div class='form-group col-lg-12 mb-3' id='fileDiv'>
            ...
            <input type="file" name="profile" id="profile" class="form-control" value="{{ $user->profile_image }}" accept="image/*" required>
