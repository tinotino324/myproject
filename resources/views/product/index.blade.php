        ...
        <div class="box-header d-flex align-items-center justify-content-start">                
            ...
            <div class="d-flex align-items-center gap-3 site-card-bg px-4 padding-site-cards justify-content-center rounded-2 question-card-width card-width">
                <div>
                    ...
                    <p class="primary-text-dark mb-0 text-center">Total Product</p>
                </div> 
    ...
    <div class="offcanvas offcanvas-end w-25" tabindex="-1" id="offcanvasAddClass" aria-labelledby="offcanvasAddClassLabel">
        <div class="offcanvas-header">
            <div class="mainTitleWrapper d-flex align-items-center gap-3">
                ...
                <h5 class="offcanvas-title" id="offcanvasAddClassLabel">Add Product</h5>
            </div>
        ...
        <div class="offcanvas-body">
            <div class="box-body">
                ...
                <div class='form-group col-lg-12 mb-3' id='edit_book_nameDiv'> 
                    <label for="gallery" class="control-label">
    ...
    <div class="offcanvas offcanvas-end w-25" tabindex="-1" id="offcanvasEditClass" aria-labelledby="offcanvasEditClassLabel">
        <div class="offcanvas-header">
            <div class="mainTitleWrapper d-flex align-items-center gap-3">
                ...
                <h5 class="offcanvas-title" id="offcanvasEditClassLabel">Edit Product</h5>
            </div>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
    ...
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="offcanvasViewClass" aria-labelledby="offcanvasViewClassLabel">
        <div class="offcanvas-header">
            <div class="mainTitleWrapper d-flex align-items-center gap-3">
                ...
                <h5 class="offcanvas-title" id="offcanvasViewClassLabel">View Product</h5>
            </div>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
...
<script>
    ...
    function save()
    {
        ...
        formData.append('name', $("#auther_name").val().trim());
        formData.append('description', $("#description").val());
        formData.append('profile', $('#profile')[0].files[0]); // actual file
        var files = $('#gallery')[0].files; // Get all selected files
        for (var i = 0; i < files.length; i++) {
            formData.append('gallery[]', files[i]); // Note the [] in name
        }
    ...
    function get_products(page_no = 0, type = '')
    {
        var length    = $("#lengthSelect").val();
        var page_no   = page_no;
        var column    = ["#", "Name", "Create Date","Action"];  
        ...
        $.ajax({
            ...
            success: function(data) 
            {
                ...
                if(result.status == true)
                {
                    ...
                    html = datatable(data, result, page_no, column, "get_products");
